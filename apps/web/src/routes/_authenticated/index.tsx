...
export const Route = createFileRoute('/_authenticated/')({
  ...
  loader: async () => {
    const [plugins, system, iot, calendar, tasks] = await Promise.all([
      settle(getPlugins()),
    ...
    return { plugins, system, iot, calendar, tasks }
  },
  component: Home,
})

function Home() {
  const { plugins, system, iot, calendar, tasks } = Route.useLoaderData()
  return (
    <PluginShell
