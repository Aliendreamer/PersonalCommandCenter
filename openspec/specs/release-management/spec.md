...
Conventional-commit-driven semantic versioning, changelog generation, git tagging, and a
unified version across the JS/Nx and .NET sides — orchestrated by Nx Release without
publishing.
